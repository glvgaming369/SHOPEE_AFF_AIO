...
// Shopee lai bi mo o tab 1 (yeu cau nguoi dung 2026-09-09). CDP port "len" (waitCdpUp qua)
// KHONG co nghia tab dau tien da xuat hien trong /json/list ngay - co khoang tre nho luc
// browser vua khoi dong, nen thu lai vai lan trong vai giay truoc khi bo cuoc (thu 1 lan
// hay bi race, roi vao dung nhanh nhanh nhu cu roi vao fallback tao tab moi).
